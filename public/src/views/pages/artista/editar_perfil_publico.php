                ...
                <form id="form-editar-perfil-publico" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <div class="d-flex align-items-center gap-3">
                            <div>
                                <img id="preview-foto" src="<?php echo BASE_URL; ?>static/img/default-profile.png" alt="Foto Perfil" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 2px solid #ddd;">
                            </div>
                            <div>

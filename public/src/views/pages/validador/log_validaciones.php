...
$page_title = "Log de Validaciones";
        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="mb-0">Log de Validaciones</h1>
                        <p class="lead">Registro de todas las validaciones y rechazos realizados por el equipo.</p>
                    </div>
                ...
                <div class="row g-3 mb-4 p-3 bg-light border rounded">
                    <div class="col-md-4">
                        ...
                        <select id="filter-action" class="form-select">
                            ...
                            <option value="VALIDACIÓN DE OBRA">Validaciones de Obras</option>
                            <option value="RECHAZO DE OBRA">Rechazos de Obras</option>
                        </select>
                    </div>
                    <div class="col-md-4">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function renderLogs(logs) {
                ...
                logs.forEach(log => {
                    ...
                    if (log.action.includes('APROBACIÓN')) badgeClass = 'bg-info';
            ...
            async function cargarLogs() {
                ...
                try {
                    ...
                    const todosLogs = await response.json();
                    
                    // Filtrar solo logs de validaciones
                    allLogs = todosLogs.filter(log => 
                        log.action.includes('VALIDACIÓN') || 
                        log.action.includes('VALIDACION') || 

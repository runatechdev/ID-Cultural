      ...
      <nav class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <?php if (isset($_SESSION['user_data'])): ?>
            <li class="nav-item"><a class="nav-link" href="/dashboard.php"><i data-lucide="user"></i> Mi Perfil</a></li>
            <li class="nav-item"><a class="btn btn-danger btn-sm" href="/logout.php">Cerrar Sesión</a></li>
          <?php else: ?>
            ...
            <li class="nav-item"><a class="btn btn-light" href="/src/views/pages/auth/registro.php">Crear cuenta</a></li>
          <?php endif; ?>
        </ul>
      </nav>
    </div>
